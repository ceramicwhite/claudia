...
import { 
  Settings, Fingerprint, Cpu, FolderOpen, Wrench, Package, ChevronDown, Package2,
  CheckSquare, Terminal, FolderSearch, Search, List, LogOut, FileText, Edit3,
  FilePlus, Book, BookOpen, Globe, ListChecks, ListPlus, Globe2, type LucideIcon
} from "lucide-react";
